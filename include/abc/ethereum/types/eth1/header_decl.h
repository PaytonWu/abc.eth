...
#if !defined(ABC_ETH_INCLUDE_ABC_ETHEREUM_TYPES_ETH1_HEADER_DECL)
#define ABC_ETH_INCLUDE_ABC_ETHEREUM_TYPES_ETH1_HEADER_DECL
...
#endif // ABC_ETH_INCLUDE_ABC_ETHEREUM_TYPES_ETH1_HEADER_DECL
