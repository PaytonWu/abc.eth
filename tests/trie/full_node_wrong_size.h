...
#if !defined(ABC_ETH_TESTS_TRIE_FULL_NODE_WRONG_SIZE)
#define ABC_ETH_TESTS_TRIE_FULL_NODE_WRONG_SIZE
...
struct full_node_data_wrong_size
{
    abc::bytes_t data0{};
    abc::bytes32_t data1{};
    abc::bytes32_t data2{};
...
void
init_full_node_data_wrong_size(full_node_data_wrong_size & fn_data, std::string_view data0, std::string_view data16)
{
    fn_data.data0 = abc::bytes_view_t{data0};
...
template <>
struct as<full_node_data_wrong_size>
{
    auto
    operator()(rlp::object const & o) const -> full_node_data_wrong_size
    {
        ...
        v.data0 = o.data.array.ptr[0].as<abc::bytes_t>();
...
template <>
struct convert<full_node_data_wrong_size>
{
    auto
    operator()(rlp::object const & o, full_node_data_wrong_size & v) const -> rlp::object const &
    {
        v = as<full_node_data_wrong_size>{}(o);
        return o;
    }
};

template <>
struct pack<full_node_data_wrong_size>
{
    template <packing_stream Stream>
    auto
    operator()(packer<Stream> & o, full_node_data_wrong_size const & v) const -> packer<Stream> &
    {
        o.pack(v.data0);
        o.pack(v.data1);
        o.pack(v.data2);
...
template <>
struct object<full_node_data_wrong_size>
{
    auto
    operator()(rlp::object &, full_node_data_wrong_size const &) const -> void
    {
    }
};
...
#endif // ABC_ETH_TESTS_TRIE_FULL_NODE_WRONG_SIZE
