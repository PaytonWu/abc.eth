...
#if !defined(ABC_ETH_TESTS_TRIE_FULL_NODE_WRONG_NESTED_FULL_NODE)
#define ABC_ETH_TESTS_TRIE_FULL_NODE_WRONG_NESTED_FULL_NODE
...
struct full_node_wrong_nested_full_node_data
{
    abc::bytes32_t data0{};
    abc::bytes32_t data1{};
    abc::bytes32_t data2{};
...
void
init_full_node_wrong_nested_full_node_data(full_node_wrong_nested_full_node_data & data, std::array<abc::bytes_t, 17> const & data15, std::string_view data16)
{
    data.data0.fill(1);
    data.data1.fill(2);
    data.data2.fill(3);
    ...
    data.data14.fill(15);
    data.data15 = data15;
    data.data16 = abc::bytes_view_t{data16};
}
...
template <>
struct as<full_node_wrong_nested_full_node_data>
{
    auto
    operator()(rlp::object const & o) const -> full_node_wrong_nested_full_node_data
    {
        ...
        full_node_wrong_nested_full_node_data v;
...
template <>
struct convert<full_node_wrong_nested_full_node_data>
{
    auto
    operator()(rlp::object const & o, full_node_wrong_nested_full_node_data & v) const -> rlp::object const &
    {
        v = as<full_node_wrong_nested_full_node_data>{}(o);
        return o;
    }
};

template <>
struct pack<full_node_wrong_nested_full_node_data>
{
    template <packing_stream Stream>
    auto
    operator()(packer<Stream> & o, full_node_wrong_nested_full_node_data const & v) const -> packer<Stream> &
    {
        o.pack(v.data0);
        o.pack(v.data1);
        o.pack(v.data2);
...
template <>
struct object<full_node_wrong_nested_full_node_data>
{
    auto
    operator()(rlp::object &, full_node_wrong_nested_full_node_data const &) const -> void
    {
    }
};
...
#endif // ABC_ETH_TESTS_TRIE_FULL_NODE_WRONG_NESTED_FULL_NODE
