...
#if !defined(ABC_ETH_TESTS_TRIE_NESTED_FULL_NODE_DATA)
#define ABC_ETH_TESTS_TRIE_NESTED_FULL_NODE_DATA
...
void
init_nest_full_node_data(nested_full_node_data & fn_data, std::string_view data15, std::string_view data16)
{
...
template <>
struct as<nested_full_node_data>
{
    auto
    operator()(rlp::object const & o) const -> nested_full_node_data
    {
...
template <>
struct convert<nested_full_node_data>
{
    auto
    operator()(rlp::object const & o, nested_full_node_data & v) const -> rlp::object const &
    {
        v = as<nested_full_node_data>{}(o);
        return o;
    }
};

template <>
struct pack<nested_full_node_data>
{
    template <packing_stream Stream>
    auto
    operator()(packer<Stream> & o, nested_full_node_data const & v) const -> packer<Stream> &
    {
        o.pack(v.data0);
        o.pack(v.data1);
        o.pack(v.data2);
...
template <>
struct object<nested_full_node_data>
{
    auto
    operator()(rlp::object &, nested_full_node_data const &) const -> void
    {
    }
};
...
#endif // ABC_ETH_TESTS_TRIE_NESTED_FULL_NODE_DATA
